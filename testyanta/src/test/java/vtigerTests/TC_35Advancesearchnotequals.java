...
public class TC_35Advancesearchnotequals extends BaseClass {
	...
	public  void Advancesearchnotequals() throws Throwable {
		...
		//opportunity created successfully and advance search with related to not equals is working-pass
