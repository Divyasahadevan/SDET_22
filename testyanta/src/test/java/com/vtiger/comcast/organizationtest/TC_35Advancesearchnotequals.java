...
public class TC_35Advancesearchnotequals {
	@Test

	public  void Advancesearchnotequals() throws Throwable {
			...
			if(actSucMsg.contains("Advanced Search")) {
				System.out.println("opportunity created successfully and advance search with related to not equals is working-pass");
			}
			else {
				System.out.println("opportunity created successfully and advance search with related to not equals is not working-fail");
			}
