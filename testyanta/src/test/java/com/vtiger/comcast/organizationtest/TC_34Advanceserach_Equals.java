...
public class TC_34Advanceserach_Equals {
	@Test

	public void AdvanceSearch_Equals() throws Throwable {
			...
			if(actSucMsg.contains("Advanced Search")) {
				System.out.println("opportunity created successfully and advance search with related to_equals is working-pass");
			}
			else {
				System.out.println("opportunity created successfully and advance search with related to_equals is not working-fail");
			}
